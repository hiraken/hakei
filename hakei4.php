...
<html xmlns="http://www.w3.org/1999/xhtml" lang="en" xml:lang="en"> 
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            var attributes = {};
            attributes.id = "hakei4";
            attributes.name = "hakei4";
            attributes.align = "middle";
            swfobject.embedSWF(
                "hakei4.swf", "flashContent", 
                "100%", "100%", 
...
<a href="../index.php"><img src = "../img/hakei.png" alt = "Hakei" width="350" height="100" border="0"></a>
        ...
        -->
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" width="550" height="400" id="hakei4" align="middle">

<param name="movie" value="hakei4.swf" />

<param name=FlashVars value="music=<?php echo $_GET['music']; ?>" />

<!--[if !IE]>-->

<object type="application/x-shockwave-flash" data="hakei4.swf" width="550" height="400">
